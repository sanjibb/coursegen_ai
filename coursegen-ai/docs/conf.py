...
"""
coursegen-ai documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'coursegen-ai',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/studyexam/coursegen-ai",
...
#
# html_title = 'coursegen-ai v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'aibot for course gen',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'coursegen-ai'),
                os.path.join(root_path, 'coursegen-ai/migrations')])
