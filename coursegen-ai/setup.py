#!/usr/bin/env python
"""
Package metadata for coursegen-ai.
"""
import os
import re
import sys
...
VERSION = get_version('coursegen-ai', '__init__.py')
...
setup(
    name='coursegen-ai',
    version=VERSION,
    description="""aibot for course gen""",
    long_description=README + '\n\n' + CHANGELOG,
    author='sanjib basak',
    author_email='info@studyexam.ai',
    url='https://github.com/sanjibb/coursegen-ai',
    packages=find_packages(
        include=['coursegen-ai', 'coursegen-ai.*'],
        exclude=["*tests"],
    ),
